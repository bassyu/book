...
> 함수의 특징을 얼마나 잘 이해하느냐가 자바스크립트 개발자로서의 역략을 판가름하는 기준이 될 수 있습니다.
...
this는 읽기 전용 값으로 런타임 시 설정할 수 없으며 **함수를 호출한 방범에 의해 값이 달라집니다.**
...
```
위 예제는 setTimeout() 함수 내에서 실행되므로 this가 전역 객체로 바인딩됩니다.
